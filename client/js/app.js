var app = angular.module('nibs', ['ionic', 'nibs.config', 'nibs.profile', 'nibs.auth', 'nibs.product', 'nibs.offer', 'nibs.store-locator', 'nibs.faq', 'nibs.gallery', 'nibs.preview', 'nibs.settings', 'nibs.case'])
